...
use PLejeune\UserBundle\Form\DeleteForm;
...
{
    /**
     * @Route(".html", name="plejeune_user_profile_delete")
     * @return Response
     */
    public function index(Request $request): Response
    {
        ...
        return $this->render('@PLejeuneUser/Delete/form.html.twig', [
            'user' => $this->getUser(),
    ...
    /**
     * @Route("-confirm.html", name="plejeune_user_profile_delete_confirm")
     * @return Response
     */
